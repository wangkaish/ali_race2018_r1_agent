...
public class AgentAppProvider {
    ...
    public static void main(String[] args) throws Exception {
        setSystemPropertiesIfNull("type", "provider");
        setSystemPropertiesIfNull("server.port", "30000");
        setSystemPropertiesIfNull("scale.type", "3");
        setSystemPropertiesIfNull("threads", "200");
        setSystemPropertiesIfNull("run_mode_local", "true");
        setSystemPropertiesIfNull("server.host", "127.0.0.1");
        setSystemPropertiesIfNull("dubbo.protocol.port", "20889");
